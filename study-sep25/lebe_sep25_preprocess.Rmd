...
df_lebe_gpt4o_extra <- readr::read_csv(paste0(repo_url,"df_lebe_gpt4o_extra.csv"), show_col_types = FALSE) %>% 
  rename(left_behind_score_revised = left_behind_score)
...
df_lebe <- df_lebe %>% 
  ...
  left_join(df_lebe_gpt4o_extra,by = "PID") %>% 
